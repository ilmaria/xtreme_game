...
impl PhysicalDevice {
    pub fn new() -> Result<PhysicalDevice, Box<Error>> {
    ...
    pub fn graphics_queue_index(&self, surface: &Surface) -> Option<u32> {
        VK_INSTANCE
            .get_physical_device_queue_family_properties(self.0)
            .iter()
            .enumerate()
